	...
	UserObject* ContextObject, CallbackFunc InputPressedFunc, CallbackFunc InputReleasedFunc)
{
	...
	{
		if(!AbilityInputActionsConfig.IsValid()) continue;

		BindAction(AbilityInputActionsConfig.InputAction, ETriggerEvent::Started, ContextObject, InputPressedFunc, AbilityInputActionsConfig.InputTag);
		BindAction(AbilityInputActionsConfig.InputAction, ETriggerEvent::Completed, ContextObject, InputReleasedFunc, AbilityInputActionsConfig.InputTag);
	}
}
